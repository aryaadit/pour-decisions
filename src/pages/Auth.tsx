...
const Auth = () => {
  ...
  if (signupStep === 'profile-setup') {
    return (
      <div className="min-h-screen flex items-center justify-center bg-background p-4 pt-[calc(1rem+env(safe-area-inset-top))]" onClick={(e) => { if (e.target === e.currentTarget) (document.activeElement as HTMLElement)?.blur(); }}>
